    ...
    <nav class="fixed w-full z-50 glass border-b border-white/10 px-6 py-4">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center space-x-8 text-sm font-medium tracking-wide">
                <a href="{{ url('/') }}" class="hover:text-gold transition font-bold">BACK TO HOME</a>
            ...
            <div id="active-orders-section" class="glass rounded-[2rem] overflow-hidden border border-white/10 p-8">
                ...
                <div class="space-y-6">
                    @forelse($orders as $order)
                        <div class="flex flex-col lg:flex-row items-center justify-between p-6 glass rounded-2xl border border-white/5 hover:border-gold/30 transition group">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach($products as $product)
                        <div class="glass p-6 rounded-3xl border border-white/5 hover:border-gold/30 transition group relative">
                            ...
                            <p class="text-gold font-black mb-3">IDR {{ number_format($product->price, 0, ',', '.') }}</p>
    ...
    <div id="addProductModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] hidden items-center justify-center p-4">
        <div class="bg-[#0b1a33] border border-white/10 rounded-[3rem] p-8 max-w-md w-full relative shadow-2xl">
            ...
            <form action="{{ route('petugas.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 block">Category</label>
                    <select name="category" required class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-gold outline-none transition appearance-none cursor-pointer">
                        <option value="main_course" class="bg-[#0b1a33]">Main Course</option>
                        <option value="snack" class="bg-[#0b1a33]">Snack</option>
                    </select>
                </div>
                <div>
    ...
    <div id="editProductModal" class="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] hidden items-center justify-center p-4">
        <div class="bg-[#0b1a33] border border-white/10 rounded-[3rem] p-8 max-w-md w-full relative shadow-2xl">
            ...
            <form id="editForm" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2 block">Category</label>
                    <select name="category" id="edit_category" required class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-gold outline-none transition appearance-none cursor-pointer">
                        <option value="main_course" class="bg-[#0b1a33]">Main Course</option>
                        <option value="snack" class="bg-[#0b1a33]">Snack</option>
                    </select>
                </div>
